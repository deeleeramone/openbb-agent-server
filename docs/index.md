...
| `openbb_agent_server.tools` | `ToolSource` | `artifacts`, `web_search`, `fetch_url`, `widget_data`, `pdf_extract`, `dashboard`, `vision_qa`, `gemini_image`, `mcp_local`, `mcp_http`, `snowflake`, `pywry_canvas`, … |
